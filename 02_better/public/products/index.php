...
if($search) {
  $statement = 
    $pdo->prepare('SELECT * FROM products WHERE title LIKE :title ORDER BY create_date DESC');
...
<?php include_once '../../views/partials/header.php' ?>
    ...
    <form >
      <div class="input-group mb-3">
        <input type="text" class="form-control" placeholder="Search for products" aria-label="Recipient's username" value="<?php echo $search ?>" name='search'>
